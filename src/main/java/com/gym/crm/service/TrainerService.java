...
public class TrainerService {
    ...
    @Autowired public TrainerService(TrainerDao trainerDao) { this.trainerDao = trainerDao; }
    ...
    public Trainer update(Trainer t) { log.info("Updating trainer id={}", t.getTrainerId()); return trainerDao.update(t); }
    public Optional<Trainer> select(Long id) { return trainerDao.findById(id); }
    public List<Trainer> selectAll() { return trainerDao.findAll(); }
}
