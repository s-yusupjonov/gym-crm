...
public class TrainerDao {
    ...
    @Autowired public TrainerDao(InMemoryStorage storage) { this.storage = storage; }
    public Trainer create(Trainer t) {
        long id = idSequence.incrementAndGet();
        t.setTrainerId(id); t.setUserId(id);
    ...
    public Optional<Trainer> findById(Long id) { return Optional.ofNullable(storage.getTrainerStorage().get(id)); }
    public List<Trainer> findAll() { return List.copyOf(storage.getTrainerStorage().values()); }
}
