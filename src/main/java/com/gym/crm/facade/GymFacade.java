...
public class GymFacade {
    ...
    public List<Trainee> getAllTrainees() { return traineeService.selectAll(); }
    ...
    public List<Trainer> getAllTrainers() { return trainerService.selectAll(); }
    ...
    public List<Training> getAllTrainings() { return trainingService.selectAll(); }
}
