...
public class Application {
    ...
    public static void main(String[] args) {
        try (var context = new AnnotationConfigApplicationContext(AppConfig.class)) {
            ...
            trainee.setFirstName("John"); trainee.setLastName("Smith"); trainee.setAddress("Baker Street 221B");
            ...
            trainer.setFirstName("Anna"); trainer.setLastName("Jones"); trainer.setSpecialization("Cardio");
